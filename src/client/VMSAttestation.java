...
public class VMSAttestation implements Callable<String> {
	...
	VMSAttestation(ClientConfiguration config) {
		this.config = config;
	}
	...
	public String call() throws Exception {
		...
		SSLSocket c = (SSLSocket) socketFactory.createSocket(config.vmsHost, config.vmsPort);
		c.startHandshake();
		...
		FileInputStream fin = new FileInputStream(config.vmsCertificate);
		...
		return new String("vms=" + Utils.toHex(attestation));
